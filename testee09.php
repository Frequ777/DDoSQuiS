...
<head>
<meta charset="utf-8">
<style> @import url("styleEE09.css") </style>
...
<?php
    ...
    $quest = mysqli_query($id_con,"SELECT * FROM ee09, arkusze WHERE ee09.nr_pytania = '$ran_question' AND ee09.id_arkusza=arkusze.id");
