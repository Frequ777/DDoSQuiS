...
<head>
<meta charset="utf-8">
<style> @import url("styleEE08.css") </style>
...
<?php
    ...
    $quest = mysqli_query($id_con,"SELECT * FROM EE08, arkusze WHERE EE08.nr_pytania = '$ran_question' AND EE08.id_arkusza=arkusze.id");
