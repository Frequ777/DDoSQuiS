<?php
    ...
    if(!empty($_POST['pytanie'])){
        ...
        $ins = mysqli_query($id_con, "insert into E13(nr_pytania, prepytanie, pytanie, odp1, odp2, odp3, odp4, Atype, poprawna, files) VALUES('$nrpytania','$prepytanie', '$pytanie' , '$odp1', '$odp2', '$odp3', '$odp4', '$Atype','$poprawna','$files')");
